 ...
 * @author vneverov
 */
public class GrdData2 implements Serializable {
...
//    }
    ...
    public GrdData2(String hex) throws GrdException {
        byte[] bb = GrdDongle.hex2byte(hex);
        deserialize(bb);
    }

    public GrdData2(String d0, String d1, String d11, String d12, String d13, String d2, String d3, long d4, String d5, String hexD6, int d7) {
        this.d0 = d0;
        this.d1 = d1;
        this.d11 = d11;
        this.d12 = d12;
    ...
    public byte[] serialize() throws GrdException {
        ...
        // шифруем AES128
        {
            ...
            errorCode = Api.GrdPI_Activate(h, 0x2, d7);
            GrdDongle.errorHandling(errorCode);
    ...
    public void deserialize(byte[] bb4) throws GrdException {
        ...
        // дешифруем AES128
        {
            ...
            GrdE errorCode = Api.GrdPI_Activate(h, 0x2, d7);
            GrdDongle.errorHandling(errorCode);

            byte[] iv = new byte[16];
            errorCode = Api.GrdPI_Read(h, 0x3, 0, iv, d7);
            GrdDongle.errorHandling(errorCode);
    ...
    public String toString() {
        ...
        sb.append("\r\n" + T1);
        sb.append("vendor           : ").append(d0).append("\r\n");
        sb.append("customer         : ").append(d1).append("\r\n");
        sb.append("customer - fio   : ").append(d11).append("\r\n");
        sb.append("customer - phone : ").append(d12).append("\r\n");
        sb.append("customer - email : ").append(d13).append("\r\n");
        sb.append("product          : ").append(d2).append("\r\n");
        sb.append("version          : ").append(d3).append("\r\n");
        sb.append("date             : ").append(sdf.format(d4)).append("\r\n");
        sb.append(T1);
        return sb.toString();
    }
